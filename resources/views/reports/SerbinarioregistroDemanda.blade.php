...
<div class="page">
    ...
    <h4 style="text-align: center">REGISTRO DE MANIFESTAÇÃO A OUVIDORIA</h4>
    ...
    <table>
        <tr>
            <td><span class="text"><b>Tipo: </b>{{$informacao}}</span></td>
    ...
    <table>
        ...
        <tr>
            ...
            <td ><span class="text"><b>Bairro:</b> {{$bairro}}</span></td>
