    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <div class="col-sm-6 col-md-9">
                <h4><i class="material-icons">find_in_page</i> Listar Assuntos</h4>
            </div>
            {{--<div class="col-sm-6 col-md-3">
                <a href="{{ route('seracademico.ouvidoria.assunto.create')}}" class="btn-sm btn-primary pull-right">Novo Assunto</a>
            </div>--}}
        </div>
        <div class="ibox-content">
            ...
            <div class="row">
                <div class="col-sm-12 col-md-12">
                    <a href="{{ route('seracademico.ouvidoria.assunto.create')}}" class="btn btn-primary">Novo Assunto</a>
                </div>
            </div>
            <br/>
            <div class="row">
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var table = $('#assunto-grid').DataTable({
                processing: true,
                serverSide: true,
                order: [[ 1, "asc" ]],
                ajax: {
