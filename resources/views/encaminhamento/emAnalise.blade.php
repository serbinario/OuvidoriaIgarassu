    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <div class="col-sm-6 col-md-9">
                <h4><i class="material-icons">find_in_page</i> Demandas em análise</h4>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="table-responsive">
                        <table id="analises-grid" class="display table compact table-bordered" cellspacing="0" width="100%">
                            <thead>
                            <tr>
                                <th>Código</th>
                                <th>Secretaria</th>
...
@section('javascript')
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            var table = $('#analises-grid').DataTable({
                processing: true,
                serverSide: true,
                bLengthChange: false,
                order: [[ 1, "asc" ]],
                ajax: {
                    url: "{!! route('seracademico.ouvidoria.encaminhamento.emAnaliseGrid') !!}",
                    method: 'POST'
                },
                columns: [
