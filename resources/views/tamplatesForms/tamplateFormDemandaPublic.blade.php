                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('relato', Session::getOldInput('relato')  ,['size' => '140x5'] , array('class' => 'form-control')) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('melhorias', Session::getOldInput('melhorias')  ,['size' => '140x5'] , array('class' => 'form-control')) !!}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            {!! Form::textarea('obs', Session::getOldInput('obs')  ,['size' => '140x5'] , array('class' => 'form-control')) !!}
                                        </div>
                                    </div>
                                </div>
