		...
		<div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #213a53; color: white">Identificação</div>
                ...
                <div class="panel panel-default dados-pessoas">
                    <div class="panel-heading dados-pessoas" style="background-color: #213a53; color: white">Dados pessoas</div>
                    <div class="panel-body dados-pessoas">
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #213a53; color: white">Dados da manifestação</div>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('relato', Session::getOldInput('relato') , array('class' => 'form-control input-sm', 'rows' => '5')) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('melhorias', Session::getOldInput('melhorias') , array('class' => 'form-control input-sm', 'rows' => '5')) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::textarea('obs', Session::getOldInput('obs') , array('class' => 'form-control input-sm', 'rows' => '5')) !!}
                                </div>
                            </div>
                        </div>
                    </div>
