    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            <div class="col-sm-6 col-md-9">
                <h4><i class="material-icons">find_in_page</i> GRÁFICO DE ESCOLARIDADES DA DEMANDA</h4>
            </div>
            {{--<div class="col-sm-6 col-md-3">
                <a href="{{ route('seracademico.ouvidoria.graficos.escolaridade') }}" target="_blank" class="btn-sm btn-primary pull-right">Imprimir</a>
            </div>--}}
        </div>
...
@section('javascript')
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $.ajax({
                url: '{{route('seracademico.ouvidoria.graficos.escolaridadeAjax')}}',
                type: 'POST',
                dataType: 'JSON',
        ...
        function  grafico (json) {
            $(function () {
                Highcharts.chart('container', {
                    ...
                    title: {
                        text: 'Quantidade de demandas por escolaridade'
                    },
                    xAxis: {
                        categories: json[0],
                        title: {
