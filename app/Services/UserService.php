        ...
        foreach ($models as $model) {
            ...
            if ($ajax) {
                if (count($expressao) > 0) {
                    switch (count($expressao)) {
                        case 1 :
                            ...
                            $result[strtolower($model)] = $nameModel::{$expressao[0]}()->orderBy('name', 'asc')->get(['name', 'id']);
                            break;
                        case 2 :
                            #Recuperando o registro e armazenando no array
                        ...
                        case 3 :
                            #Recuperando o registro e armazenando no array
                            $result[strtolower($model)] = $nameModel::{$expressao[0]}($expressao[1], $expressao[2])->orderBy('name', 'asc')->get(['name', 'id']);
                            break;
                    }
                } else {
                    #Recuperando o registro e armazenando no array
                ...
                if (count($expressao) > 1) {
                    #Recuperando o registro e armazenando no array
                    $result[strtolower($model)] = $nameModel::{$expressao[0]}($expressao[1])->orderBy('name', 'asc')->lists('name', 'id');
                } else {
                    #Recuperando o registro e armazenando no array
                    $result[strtolower($model)] = $nameModel::orderBy('name', 'asc')->lists('name', 'id');
                }
            }
