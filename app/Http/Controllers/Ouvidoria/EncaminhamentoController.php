...
class EncaminhamentoController extends Controller
{
    ...
    */
    public function __construct(EncaminhamentoService $service, EncaminhamentoValidator $validator)
    {
    ...
    {
        #Criando a consulta
        $rows = \DB::table('encaminhamento')->select(['id', 'nome']);
    ...
    public function create()
    {
        ...
        #Retorno para view
        return view('encaminhamento.create', compact('loadFields'));
    }
    ...
    public function edit($id)
    {
        try {
            ...
            #retorno para view
            return view('encaminhamento.edit', compact('model', 'loadFields'));
